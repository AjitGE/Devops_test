...
public class AptController 
{
	...
	public void getPromosFromVentana(String pcode) throws IOException {
		...
		if(logger.isDebugEnabled())
			logger.debug("Time elapsed to consume Ventana partial Promo code search service for given code {} : {} (in Millis)",pcodepromocurrval[0],parseVentanaPartialPromoSearchTimeElapsed);
