...
@ExtendedCucumberOptions(
		...
		jsonReport = "target/cucumber-report/Smoke/cucumber.json", jsonUsageReport = "target/cucumber-report/Smoke/cucumber-usage.json", outputFolder = "target/cucumber-report/Smoke", toPDF=true,detailedReport = true, detailedAggregatedReport = true, overviewReport = true, usageReport = true)
...
@CucumberOptions(
		...
		tags = {"@TestId_APS_18"}, monochrome = true, plugin = { "pretty", "pretty:target/cucumber-report/Smoke/pretty.txt",
