        ...
        stage ('Integration Tests') {
            ...
            steps {
                ...
                script {
                    ...
                    sh "docker run --rm -i --name zalenium -p 48410:4444 -v /var/run/docker.sock:/var/run/docker.sock -v /tmp/videos:/home/seluser/videos --privileged dosel/zalenium start --sendAnonymousUsageInfo false"
